...
# If pip install PIL didn't work try to install Pillow which is a PIL fork
...
class Paint():
    ...
    def __init__(self, root):
        ...
        # bd is border ; relief = ridge is the type of button, it has other types such as sunken, raised etc
